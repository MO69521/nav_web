...
import { canAttemptCloudBaseSignup, createPublicShareURL, createShareToken, isExistingCloudBaseAccountError, isSafeNoteImageSource } from '../cloud-content.js';
...
test('CloudBase rules keep workspaces private and shared notes publicly readable', () => {
  ...
  assert.match(workspaceRules.read, /doc\.ownerId == auth\.uid/);
